...
rD = containers.Map();
% Prod =
rD('CAR_D5') = Find_in_RI2E('CAR_D5');
rD('CAR_D7') = Find_in_RI2E('CAR_D7');
rD('CAR_N6') = Find_in_RI2E('CAR_N6');
rD('CAR_N8') = Find_in_RI2E('CAR_N8');
rD('CAR_T11') = Find_in_RI2E('CAR_T11');
rD('CAR_T16') = Find_in_RI2E('CAR_T16');
rD('CAR_T21') = Find_in_RI2E('CAR_T21');



% Loss =
rD('CAR_I7') = Find_in_RI2E('CAR_I7');
rD('CAR_I8') = Find_in_RI2E('CAR_I8');
rD('CAR_D3') = Find_in_RI2E('CAR_D3');
...
production_keys = {'CAR_D5','CAR_D7','CAR_N6','CAR_N8','CAR_T11','CAR_T16','CAR_T21'};
production_indices = [rD('CAR_D5'),rD('CAR_D7'),rD('CAR_N6'),rD('CAR_N8'),rD('CAR_T11'),rD('CAR_T16'),rD('CAR_T21')];;
...
loss_keys = {'CAR_I7','CAR_I8','CAR_D3'};
loss_indices = [rD('CAR_I7'),rD('CAR_I8'),rD('CAR_D3')];
